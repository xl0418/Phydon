...
We recommend users to use the GTDB database for their ASV sequences queries. The following script can be used to convert the ASV sequences to the accession numbers of the genomes in the GTDB database:
...
This script will download the GTDB database and create a blast database. Users can then use the following script to convert the ASV sequences to the accession numbers of the genomes in the GTDB database:
...
The output of the script will be a tab-delimited file that contains the accession numbers of the genomes in the GTDB database and several stats. Users can then extract the accession numbers and fetch the trait data from our trait database. 
